...
/**
 * Input and output handle for reading and writing from parallel workers. This
 * will also abstract the in-memory executions from mapper and reducer. Map and
 * reduce will perform as they read and wrote to HDFS, but it may not be the
 * case always and it completely depends on the implementations of this class.
 *
 * @author nikit
 *
 */
public class IOHandle implements Serializable {
    private static final long serialVersionUID = 3329570567984805104L;
    /**
     * I/O Handles
     */
     ...
     */
    public IOHandle(String inFile, String outDir) throws FileNotFoundException,
    ...
    public IOHandle(IOHandle io) throws FileNotFoundException,
            UnsupportedEncodingException {
        getIOHandle();
    }
